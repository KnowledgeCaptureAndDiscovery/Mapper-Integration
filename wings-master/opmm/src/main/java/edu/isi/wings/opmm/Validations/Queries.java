...
public class Queries {
    ...
    //OPT1: ALL EXECUTIONS MUST HAVE AN EXECUTION DIAGRAM
    private static final String EXECUTIONS_WITHOUT_EXECUTION_DIAGRAM =""
            + "?acc a <http://www.opmw.org/ontology/WorkflowExecutionAccount>."
            + "FILTER NOT EXISTS{"
            + "?acc <http://www.opmw.org/ontology/hasExecutionDiagram> ?diag."
            + "}"
            + "}";
    public static final String FIND_ACCOUNT_CONDITION_1=ACCOUNT_COUNT+EXECUTIONS_WITHOUT_EXECUTION_DIAGRAM;
    ...
    //OPT: TEMPLATES SHOULD HAVE A DATA PROPERTY CREATED_IN_THE_WORKFLOW_SYSTEM
    
    private static final String TEMPL_WITHOUT_BEING_CREATED_IN_THE_WORKFLOW_SYSTEM=""
            + "?t a <http://www.opmw.org/ontology/WorkflowTemplate>"            
            + "FILTER NOT EXISTS{"
            + "?t <http://www.opmw.org/ontology/createdInWorkflowSystem> ?crea."
            + "}"
            + "}";
    public static final String FIND_TEMPLATE_CONDITION_1=TEMPLATE_COUNT+TEMPL_WITHOUT_BEING_CREATED_IN_THE_WORKFLOW_SYSTEM;
    
    
//OPT: TEMPLATES SHOULD HAVE A DATA PROPERTY HAS_TEMPLATE_DIAGRAM
    
    private static final String TEMPL_WITHOUT_HAVING_TEMPLATE_DIAGRAM=""
            + "?t a <http://www.opmw.org/ontology/WorkflowTemplate>"            
            + "FILTER NOT EXISTS{"
            + "?t <http://www.opmw.org/ontology/hasTemplateDiagram> ?diag."
            + "}"
            + "}";
